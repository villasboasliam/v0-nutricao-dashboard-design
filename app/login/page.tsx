...
export default function LoginPage() {
    ...
    useEffect(() => {
        ...
        console.log("Parâmetro 'error' na URL:", error);
        if (error === "CredentialsSignin") {
            console.log("Definindo errorMessage para 'Senha incorreta' via URL");
    ...
    const handleLogin = async (e: React.FormEvent) => {
        ...
        if (res?.error) {
            ...
            setErrorMessage("Senha incorreta"); // Define a mensagem de erro diretamente no estado
            // toast({ // Removi o toast destrutivo para evitar duplicação da mensagem
